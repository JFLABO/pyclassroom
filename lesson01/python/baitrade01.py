...
def say_mess():
    ...
    speech.Speak("Hello Pythonスリー World!きんうんひきよせ　いま05:00です")
    speech.Speak("やった　みんなありがとう。目標レートまでもう少し")
    speech.Speak("日本時間の朝ごじくらいから10分でユーロドルもっとさがるといいな")
    speech.Speak("あぽろん　アレックス　次の判定は日本時間の５時に二十分")
    speech.Speak("このプロジェクトチームにお願いしたい方針はつねにじょうきげんで、ゆうがにかまえていること")
    speech.Speak("みんなで協力すればきっとうまくいくよ　つぎのはんていまであと25分です。今日も明るく元気に余裕で勝ちましょう")
